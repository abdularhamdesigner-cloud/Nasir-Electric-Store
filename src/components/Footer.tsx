      ...
      <div className="max-w-7xl mx-auto px-6 py-14 grid grid-cols-1 md:grid-cols-3 gap-12 text-left text-xs font-sans">
        ...
        <div className="space-y-4 col-span-1 text-left">
          ...
          <p className="text-[12px] text-slate-500 font-sans leading-relaxed max-w-sm">
            Serving Pakistan with premium electrical hardware, appliances, smart solar, coolers, fans, and architectural lighting since 1968. 58 years of quality, reliability, and client-centered trust based in Mailsi.
          </p>
        ...
        <div className="space-y-4 text-left">
          ...
          <ul className="space-y-3 font-sans font-semibold text-slate-500">
            ...
            <li><button onClick={() => handleNavClick('products', 'electronics')} className="hover:text-[#F39C12] transition-colors cursor-pointer block text-left">Coolers &amp; Fans Portfolio</button></li>
