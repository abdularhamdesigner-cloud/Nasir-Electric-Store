...
const SCROLLING_REVIEWS = [
  ...
  { name: 'Mian Jahangir', location: 'Mailsi', rating: 4, comment: 'Outstanding guidance on tubular battery setups! Osaka TA-1800 is running our home fans perfectly.', date: 'May 20, 2026' },
